    ...
    return (
      <div>
        <Container>
          <h4>About</h4>
          <p>
            This is a simple calculator app meant for use in the 5/3/1
            progressive overload weightlifting schema developed by body-builder
            Jim Wendler. After inputting your 1 rep maxes, it will tell you what
            weights to use for each week as well as how to structure your sets.
